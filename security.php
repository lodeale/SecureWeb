<?php
/*
 * modulo de seguridad para filtrado de xss e InjecciÛn SQL
 */
 	 ...
 	 function chance($type="active"){
 		switch($type):
 			case "active":
				...
				echo "<h3>WARNING: </h3>";
				echo "Hacker est√° usted siendo investigado<hr>";
